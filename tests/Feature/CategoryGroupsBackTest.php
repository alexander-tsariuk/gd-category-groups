...
class CategoryGroupsBackTest extends TestCase
{
    /**
    ...
    public function test_backend_create_success() {
        $response = $this->json('POST', '/api/v1/categories/groups/backend/create', [
    ...
    public function test_backend_update_success() {
        $response = $this->json('PUT', '/api/v1/categories/groups/backend/update/99999', [
    ...
    public function test_backend_update_notExists() {
        $response = $this->json('PUT', '/api/v1/categories/groups/backend/update/99998', [
            'name' => 'Testing The Test Category Group Updated',
            'seo_name' => 'testing-the-test-category-group',
            'status' => 0,
        ], [
    ...
    public function test_backend_getOne_success() {
        $response = $this->json('GET', '/api/v1/categories/groups/backend/getOne/99999', [], [
            'site-id' => 999,
            'site-key' => 'site_key',
            'user-id' => 777
        ]);
    ...
    public function test_backend_getOne_notExists() {
        $response = $this->json('GET', '/api/v1/categories/groups/backend/getOne/99998', [], [
            'site-id' => 999,
            'site-key' => 'site_key',
            'user-id' => 777
        ]);
    ...
    {
        $response = $this->json('GET', '/api/v1/categories/groups/backend/getList', [], [
            'site-id' => 1,
            'site-key' => 'site_key',
            'user-id' => 22
        ]);
    ...
    public function test_backend_soft_delete_success() {
        $response = $this->json('DELETE', '/api/v1/categories/groups/backend/delete/99999?soft=true', [], [
            'site-id' => 999,
            'site-key' => 'site_key',
            'user-id' => 777
        ]);
    ...
    public function test_backend_soft_delete_notExists() {
        $response = $this->json('DELETE', '/api/v1/categories/groups/backend/delete/99998?soft=true', [], [
            'site-id' => 999,
            'site-key' => 'site_key',
            'user-id' => 777
        ]);
    ...
    public function test_backend_delete_success() {
        $response = $this->json('DELETE', '/api/v1/categories/groups/backend/delete/99999', [], [
            'site-id' => 999,
            'site-key' => 'site_key',
            'user-id' => 777
        ]);
     ...
     * @return void
     */
    public function test_frontend_getMenu_success() {
        $response = $this->json('GET', '/api/v1/categories/groups/frontend/getMenu', [], [
            'site-id' => 1,
            'site-key' => 'site_key',
        ]);
